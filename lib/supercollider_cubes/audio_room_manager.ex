defmodule SupercolliderCubes.AudioRoomManager do
  @moduledoc """
  ...
  @impl true
  def init(_opts) do
    Logger.info("Starting AudioRoomManager")
    {:ok, %{pipelines: %{}}}
  end
  ...
  def handle_call({:add_peer, peer_id}, _from, state) do
    ...
    {:ok, _supervisor, pipeline} =
      Membrane.Pipeline.start_link(AudioRoom, signaling_id: "audio:#{peer_id}")
